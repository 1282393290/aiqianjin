...
export default class Leftintroduce extends Component {
  render() {
   ...
   {/* 平台数据 */}
      ...
      {/* 荣誉奖项 */}
      <div className="mian-top honor-img">
        <div className="mian-img">
        <i className="icon-rongyu"></i>
          <p>团队介绍</p>
        </div>
      </div>
      ...
      <div className="honor">
        ...
        <div className="honorCircle">
          <div className="honor-qq">
            <div className="honorreset  honor-rotate">
            <i >2017年<br/>07月</i>
            </div>

            <div className="honor-rotate-txt">
              <span></span>
               <p >参加2017中国互联网大会“互联网金融高峰论坛”</p>
            </div>
            <div className="honorreset honor-rotate2">
            <i >2017年<br/>07月</i>
            </div>

            <div className="honor-rotate-txt2">
              <span></span>
               <p >参加第七届上海新金融年会暨第四届金融科技外滩峰会</p>
            </div>
